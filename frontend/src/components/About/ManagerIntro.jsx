    ...
    departments: [
      {
        ...
        intro: '필드 18기 기획부장 김요한입니다.\n\n앞으로의 필드가 더 나은 방향으로 나아갈 수 있도록, 기획부에서 안정적인 기반을 만들고 새로운 시도를 준비하고자 합니다. 산업공학도의 시각에서, 필드가 가진 가능성을 현실적인 방식으로 확장하고 더 넓은 도전의 기회를 만들어가겠습니다.\n\n기획부는 구성원들의 아이디어가 실제 활동으로 이어지는 곳인 만큼, 각자의 생각이 자연스럽게 드러나고 성장으로 연결될 수 있도록 노력하겠습니다. 필드가 앞으로도 계속 발전하고, 함께 도전하며 더 큰 목표를 향해 나아갈 수 있도록 책임감을 가지고 기획부를 이끌겠습니다. 감사합니다.'
      },
      {
        id: 4,
